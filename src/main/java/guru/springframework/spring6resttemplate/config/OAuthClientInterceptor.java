...
public class OAuthClientInterceptor implements ClientHttpRequestInterceptor {
    ...
    public OAuthClientInterceptor(@Qualifier("OAuth2AuthorizedClientManager") OAuth2AuthorizedClientManager manager, ClientRegistrationRepository clientRegistrationRepository) {
